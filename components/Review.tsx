    ...
    },
    {
        ...
        content: (
            <div className="space-y-4 text-left w-full max-w-md mx-auto">
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 divide-y divide-white/5 max-h-60 overflow-y-auto custom-scrollbar">
    ...
    },
    {
        ...
        content: (
            <div className="w-full max-w-md mx-auto">
                ...
                <textarea 
                    className="w-full h-32 p-4 rounded-xl border border-white/10 bg-white/5 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none placeholder:text-white/20"
