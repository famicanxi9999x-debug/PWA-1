...
const ExpandOnHover: React.FC<ExpandOnHoverProps> = ({ onSelect, selectedUrl }) => {
  ...
  // Adjusted widths for modal context
  const getImageWidth = (index: number) =>
    index === expandedImage ? "140px" : "50px";

  return (
    <div className="w-full py-4">
      <div className="flex w-full items-center justify-center gap-2 overflow-x-auto p-2 no-scrollbar">
        {images.map((src, idx) => {
