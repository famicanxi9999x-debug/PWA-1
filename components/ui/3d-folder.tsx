...
export interface Project {
  ...
  image: string
  title: string
  action?: string; // Added for navigation mapping
}
...
interface AnimatedFolderProps {
  ...
  projects: Project[]
  className?: string
  onProjectSelect?: (project: Project) => void; // Callback for navigation
}

export function AnimatedFolder({ title, projects, className, onProjectSelect }: AnimatedFolderProps) {
  ...
  const handleProjectClick = (project: Project, index: number) => {
    // If a custom handler exists (for navigation), use it and skip lightbox
    if (onProjectSelect) {
    ...
    <>
      <div
        className={cn(
          ...
          "bg-white/5 border border-white/10", // Adapted colors for dark theme consistency
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle at 50% 70%, rgba(99, 102, 241, 0.15) 0%, transparent 70%)",
        ...
        <div className="relative flex items-center justify-center mb-4" style={{ height: "160px", width: "200px" }}>
          ...
          <div
            className="absolute w-32 h-24 bg-[hsl(var(--folder-back))] rounded-lg shadow-md"
            style={{
          ...
          <div
            className="absolute w-12 h-4 bg-[hsl(var(--folder-tab))] rounded-t-md"
            style={{
          ...
          <div
            className="absolute w-32 h-24 bg-[hsl(var(--folder-front))] rounded-lg shadow-lg"
            style={{
        ...
        {/* Project count */}
        <p
          className="text-sm text-white/50 transition-all duration-300"
          style={{
        ...
        {/* Hover hint */}
        <div
          className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 text-xs text-white/40 transition-all duration-300 w-full justify-center"
          style={{
...
export function ImageLightbox({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn("relative overflow-hidden", "rounded-2xl", "bg-[#1a1a2e]", "ring-1 ring-white/10", "shadow-2xl")}
          style={{
        ...
        >
          ...
          <div
            className={cn("px-6 py-5", "bg-[#141428]", "border-t border-white/5")}
            style={{
              opacity: animationPhase === "complete" && !isClosing ? 1 : 0,
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  <p className="text-sm text-white/50">
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-xs font-medium bg-white/5 text-white/70 rounded border border-white/10">
                      ←
                    </kbd>
                    <kbd className="px-1.5 py-0.5 mx-0.5 text-xs font-medium bg-white/5 text-white/70 rounded border border-white/10">
                      →
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "cursor-pointer hover:ring-2 hover:ring-indigo-400/50",
